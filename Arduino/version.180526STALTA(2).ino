...
void setup() {
  ...
  setFullScaleAccelRange(MPU9250_FULL_SCALE_2G);
...
float* stalta_rt (float z0, float z1, float r1_local, float sta1_local, float lta1_local, float *temp) {
...
bool checkTriggerThreshold(float valX0 , float valY0, float valZ0 ) {
    ...
    float xtemp[3]; 
    stalta_rt(accX0, accX1, rX1, staX1, ltaX1, xtemp);
    float ytemp[3]; 
    stalta_rt(accY0, accY1, rY1, staY1, ltaY1, ytemp);
    float ztemp[3]; 
    stalta_rt(accZ0, accZ1, rZ1, staZ1, ltaZ1, ztemp);
    ...
    Serial.println("sta X Y Z");
    Serial.println(staX0);
    Serial.println(staY0);
    Serial.println(staZ0);
    Serial.println("lta X Y Z");
    Serial.println(ltaX0);
    Serial.println(ltaY0);
    Serial.println(ltaZ0);
